          ...
          <div className="relative z-50 w-max">
            ...
            {isGenreDropdownOpen && (
              <>
                ...
                <div className="absolute left-full -top-12 ml-2 w-[280px] sm:w-[320px] bg-brand-surface rounded-[24px] border border-brand-border/30 shadow-dropdown z-50 p-5 animate-in fade-in slide-in-from-left-2 duration-200">
