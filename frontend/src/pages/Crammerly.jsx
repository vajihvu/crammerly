...
export default function Crammerly() {
  ...
  return (
    <div className={`!bg-brand-bg font-sans selection:bg-brand-primary/30 relative flex flex-col ${isInRoom ? 'lg:h-screen lg:overflow-hidden min-h-screen' : 'min-h-screen'}`}>
      <Header
        isInRoom={isInRoom}
        leaveRoom={leaveRoom}
        modals={modals}
